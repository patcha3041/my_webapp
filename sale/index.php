...
$summaryPrice = 0;
foreach($sum as $sumDate) {
  $summaryPrice = $summaryPrice + $sumDate['sale_summary_price'];
  echo "<tr>
    <td>{$sumDate['name']}</td>
    <td>{$sumDate['amount']}</td>
    <td>{$sumDate['sale_amount']}</td>
    <td>{$sumDate['sale_summary_price']}</td>
  </tr>";
}
?>
          </tbody>
